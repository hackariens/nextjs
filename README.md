...
![Continuous Integration](https://github.com/hackariens/nextjs/actions/workflows/ci.yml/badge.svg?branch=develop)
...
```sh
git clone --recursive git@github.com:hackariens/nextjs.git nextjs
cd nextjs
```
